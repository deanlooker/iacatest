view: dm_application {
  ...
  sql_table_name: ( select * from DM_APALON.DIM_DM_APPLICATION where SOURCE_EXIST /*and org='apalon'*/) ;;
  #
  ...
  dimension: UNIFIED_NAME_PLATFORM {
    hidden: no
    description: "Unified App Name, Platform"
    label: "Unified App Name, Platform"
    type: string
    sql: ${TABLE}.UNIFIED_NAME || ' ' || ${PLATFORM};;
  }
  ...
  dimension: ORG {
    ...
    label: "Organization"
    type: string
    sql: ${TABLE}.ORG_REPORT--case when ${APP_FAMILY_NAME}='Translation' then 'iTranslate' else ${TABLE}.ORG end
    ;;
  }
