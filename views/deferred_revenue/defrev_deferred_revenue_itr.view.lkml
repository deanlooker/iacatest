view: defrev_deferred_revenue_itr {
  derived_table: {
    sql:
    --set (subs_info,period_start,period_end) =('01Y','2019-01-01','2019-01-31');
    select transaction_date as date,end_date,status,days_in_sub,days_in_period,round(sum(eur_gross_revenue)/days_in_period,2) as total_rev
    ...
    lc_gross_revenue/u.rate as eur_gross_revenue
    ...
    iff(r.store='iTunes', net_amount_lc*100/(100-commission_pct), net_amount_lc)  as lc_gross_revenue
